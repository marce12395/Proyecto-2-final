<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CP_Asignaciones.aspx.cs" Inherits="Proyecto_2_final.CapaPresentacion.CP_Asignaciones" %>
...
<body>
  ...
  <asp:TextBox ID="fechaA" TextMode="Date" runat="server" Height="31px" Width="691px"></asp:TextBox>

           
            &nbsp;<asp:Button ID="btnAgregar" runat="server" CssClass="aspNetButton" Text="Agregar Cliente" OnClick="btnAgregar_Click1"   />
            <asp:Button ID="btnModificar" runat="server" CssClass="aspNetButton" Text="Modificar Cliente por AsignacioID" OnClick="btnModificar_Click1"   />
            <asp:Button ID="btnEliminar" runat="server" CssClass="aspNetButton" Text="Eliminar Cliente por AsignacioID" OnClick="btnEliminar_Click1"  />
